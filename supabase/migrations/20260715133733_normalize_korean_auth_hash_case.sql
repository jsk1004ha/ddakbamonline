-- Supabase Auth lowercases the complete email address, including its opaque
-- local part. Mirror that normalization without truncating the encoded digest.
...
begin
  ...
  then
    ...
    expected_email_local_part := 'u-' || lower(
      translate(
        rtrim(
          encode(
